...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sf', ':lua require"telescope.builtin".find_files({ hidden = true })<CR>', { desc = '[S]earch [F]iles' })
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      format_on_save = function(bufnr)
        ...
        local disable_filetypes = { c = true, cpp = true, java = true, kt = true }
  ...
  { -- Autocompletion
    ...
    event = 'InsertEnter',
    dependencies = {
      -- NOTE: We have removed LuaSnip and cmp_luasnip
    ...
    config = function()
      ...
      cmp.setup {
        -- NOTE: We have removed the snippet expansion block
